						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-sm-7">
										<v-select v-bind:options="onlyBranch" v-model="selectedWarehouse" label="Brunch_name"></v-select>
									</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					...
					<tbody style="display:none;" v-bind:style="{display: cart.length > 0 ? '' : 'none'}">
						<tr v-for="(product, sl) in cart">
							...
							<td>
								<input type="text" v-model="product.purchaseRate" class="form-control" v-on:input.prevent="updateCart(product)" style="color: #000;text-align: center;">
							</td>
		...
		methods: {
			modelOnChange() {
				if(this.selectedModel.model_id != ''){
					...
					isService: 'false', model_id: this.selectedModel.model_id
					}).then(res => {
