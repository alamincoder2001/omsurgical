		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				...
				<!-- <div class="form-group clearfix" >
					...
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.Product_Code_2">
					</div>
				</div> -->
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control" v-if="models.length == 0"></select>
						<v-select v-bind:options="models" v-model="selectedModel" label="model_name" v-if="models.length > 0"></v-select>
					</div>
					<div class="col-md-1" style="padding:0;margin-left: -15px;"><a href="/model" target="_blank" class="add-button"><i class="fa fa-plus"></i></a></div>
				</div>
		...
		methods: {
			...
			saveProduct() {
				...
				if (this.selectedModel != null) {
					this.product.model = this.selectedModel.model_id;
				}
