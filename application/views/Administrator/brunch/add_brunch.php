    ...
    <div class="row" style="margin-top: 15px;">
        <div class="col-md-12" style="margin-bottom: 10px;">
            <div class="form-group">
                ...
                <div class="radio inline-radio col-sm-1" style="margin: 0px;">
                    <label>
                        <input v-model="creatType" id="branch" type="radio" value="branch" />
                        <span class="lbl"> Branch</span>
                    </label>
                </div>
                <div class="radio inline-radio col-sm-1" style="margin-top: 0px;">
                    <label>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    <tr v-for="(branch, sl) in branches">
                        <td>{{ sl + 1 }}</td>
                        <td>{{ getBranch(branch.MainBranch_Id) }}</td>
...
<script>
    new Vue({
        ...
        computed: {
            onlyBranch() {
                return this.branches.filter(b => b.MainBranch_Id == null);
            }
        },
        methods: {
            getBranch(val) {
                ...
                this.branches.forEach(element => {
                    if (element.brunch_id == val) {
                        branch = element.Brunch_name;
                    }
                });
                return branch;
            },
