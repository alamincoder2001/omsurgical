...
<div id="customers">
	<div class="row" style="margin-bottom: 4px;">
		<div class="col-md-12">
			<button style="border:none" v-on:click="uploadType = 'fromUpload'" :class="uploadType == 'fromUpload' ? 'selectType' : ''">Form Upload</button>
			<button style="border:none" v-on:click="uploadType = 'fileUpload'" :class="uploadType == 'fileUpload' ? 'selectType' : ''">Excel Import</button>
		</div>
	</div>
	<form v-if="uploadType == 'fileUpload'" id="import_excel_form" method="post" enctype="multipart/form-data">
		<div class=" row" style="border:1px solid #aaa;padding:48px 0px; margin:0px 0px 5px;">
			<div class="col-md-6 col-md-offset-3">
				<span id="message"></span>
				<div class="form-group">
					<label class="control-label">Select Excel File:</label>
					<input style="display: block;height: 36px;" type="file" class="form-control" required>
				</div>
				<div class="form-group" style="text-align: center;margin-top: 20px;">
					<input type="submit" value="Upload File" id="import" name="import" style="background: #4caf50;padding: 5px 20px;border: none;color: #fff;">
				</div>
			</div>
		</div>
	</form>
